...
const CreateUser = () => {
  ...
  const handleFormSubmit = async (values) => {
    ...
    try {
      const response = await axios.post('https://murtazamahm018-backend.mdbgo.io/api/users/create-user', {
        ...values,
      ...
      await axios.get('https://murtazamahm018-backend.mdbgo.io/api/createUser/mail', {
        params: {
