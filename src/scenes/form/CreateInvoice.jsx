...
const CreateInvoice = () => {
  ...
  const fetchInvoices = async () => {
    try {
      const response = await axios.get('https://murtazamahm018-backend.mdbgo.io/api/create-invoices');
  ...
  const handleFormSubmit = async (values) => {
    try {
      const response = await axios.post('https://murtazamahm018-backend.mdbgo.io/api/invoices', {
        ...values,
